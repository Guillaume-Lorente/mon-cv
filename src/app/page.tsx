...
const featured = [
  ...
  { title: 'Nation Sounds Festival', description: 'Site web mobile-first d\'un festival de musique.', tags: ['React', 'Node.js', 'PostgreSQL', 'i18n'], href: 'https://nation-sounds.alwaysdata.net/', imageSrc: '/images/nation-sounds.png', imageAlt: 'Accueil du site web Nation Sounds Festival' },
];
